...
class PsConst {
  ...
  static const String VALUE_HOLDER__USER_FLAG = 'USER_FLAG';
  ...
  static const String VALUE_HOLDER__CONTACT_PHONE = 'CONTACT_PHONE';
  static const String VALUE_HOLDER__CONTACT_EMAIL = 'CONTACT_EMAIL';
  static const String VALUE_HOLDER__CONTACT_WEBSITE = 'CONTACT_WEBSITE';
  ...
  static const String REJECT_STATUS = 'Rejected';
  ...
  static const int REQUEST_CODE__MENU_ACTIVE_ORDER_FRAGMENT = 1016;
  static const int REQUEST_CODE__MENU_ORDER_HISTORY_FRAGMENT = 1017;
  ...
  static const int REQUEST_CODE__MENU_PENDING_USER_FRAGMENT = 1026;
  static const int REQUEST_CODE__MENU_REJECTED_USER_FRAGMENT = 1027;

  // static const int REQUEST_CODE__MENU_USER_PROFILE_FRAGMENT = 2001;
  // static const int REQUEST_CODE__MENU_FORGOT_PASSWORD_FRAGMENT = 2002;
  // static const int REQUEST_CODE__MENU_REGISTER_FRAGMENT = 2003;
  // static const int REQUEST_CODE__MENU_VERIFY_EMAIL_FRAGMENT = 2004;
  // static const int REQUEST_CODE__DASHBOARD_SHOP_INFO_FRAGMENT = 2005;
  // static const int REQUEST_CODE__MENU_SELECT_WHICH_USER_FRAGMENT = 2006;
  ...
  // static const int REQUEST_CODE__MENU_LOGIN_FRAGMENT = 2009;
  // static const int REQUEST_CODE__MENU_PHONE_SIGNIN_FRAGMENT = 2010;
  // static const int REQUEST_CODE__MENU_PHONE_VERIFY_FRAGMENT = 2011;
  // static const int REQUEST_CODE__MENU_FB_SIGNIN_FRAGMENT = 2012;
  ...
  // static const int REQUEST_CODE__MENU_HOME_FRAGMENT = 2015;
