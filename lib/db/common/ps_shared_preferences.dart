...
// Singleton instance
  ...
  Future<dynamic> loadValueHolder() async{
    ...
    final String _isDeliveryBoy =
        shared.getString(PsConst.VALUE_HOLDER__USER_FLAG);
    final String _shopName = shared.getString(PsConst.VALUE_HOLDER__SHOP_NAME);
    final String _contactPhone =
        shared.getString(PsConst.VALUE_HOLDER__CONTACT_PHONE);
    final String _contactEmail =
        shared.getString(PsConst.VALUE_HOLDER__CONTACT_EMAIL);
    final String _contactWebsite =
  ...
  Future<dynamic> replaceIsDeliveryBoy(String userFlag) async {
    await shared.setString(PsConst.VALUE_HOLDER__USER_FLAG, userFlag);
  ...
  Future<dynamic> replaceLoginUserData(
      ...
      String userId,
      String userDeliveryBoyFlag) async {
    ...
    await shared.setString(PsConst.VALUE_HOLDER__USER_ID, userId);
    await shared.setString(
        PsConst.VALUE_HOLDER__USER_FLAG, userDeliveryBoyFlag);
  ...
  Future<dynamic> replaceContactInformation(
    ...
    await shared.setString(PsConst.VALUE_HOLDER__CONTACT_PHONE, contactPhone);
    await shared.setString(PsConst.VALUE_HOLDER__CONTACT_EMAIL, contactEmail);
    await shared.setString(
        PsConst.VALUE_HOLDER__CONTACT_WEBSITE, contactWebsite);
