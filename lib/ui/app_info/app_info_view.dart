...
import 'package:flutterrtdeliveryboyapp/provider/about_app/about_app_provider.dart';
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    child: Text(data.aboutEmail,
                        style: Theme.of(context).textTheme.bodyText1),
                    onTap: () async {
                      if (await canLaunch('mailto:ayah@gmail.com')) {
                        await launch('mailto:ayah@gmail.com');
                      } else {
                        throw 'Could not launch ayah@gmail.com';
                      }
                    },
                  ),
                ],
