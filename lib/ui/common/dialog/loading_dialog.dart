...
//       progress: 0.0,
//       maxProgress: 100.0,
//       progressTextStyle: TextStyle(color: PsColors.black, fontSize: 13.0, fontWeight: FontWeight.w400),
//       messageTextStyle: TextStyle(color: PsColors.black, fontSize: 15.0, fontWeight: FontWeight.w600));
