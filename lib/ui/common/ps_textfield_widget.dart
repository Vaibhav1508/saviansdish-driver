...
class PsTextFieldWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //         ? Theme.of(context).textTheme.bodyText1.copyWith(color: PsColors.textPrimaryLightColor)
    ...
    //             hintText: hintText,
    //             hintStyle: Theme.of(context).textTheme.bodyText1.copyWith(color: PsColors.textPrimaryLightColor),
    //           )
    //         : InputDecoration(
    //             contentPadding: const EdgeInsets.only(
    //               left: PsDimens.space12,
