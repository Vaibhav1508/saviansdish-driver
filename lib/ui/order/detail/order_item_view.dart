    ...
    return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            if (transaction.productCustomizedName.isNotEmpty)
              _OrderTwoLineTextWidget(
                transationInfoText: ' ${transaction.productCustomizedName}',
                title:
                    Utils.getString(context, 'transaction_detail__customized'),
              ),
            if (transaction.productAddonName.isNotEmpty)
              _OrderTwoLineTextWidget(
                transationInfoText: ' ${transaction.productAddonName}',
                title: Utils.getString(context, 'transaction_detail__add_on'),
              ),
            const SizedBox(
...
class _OrderTwoLineTextWidget extends StatelessWidget {
  const _OrderTwoLineTextWidget({
    Key key,
    @required this.transationInfoText,
    this.title,
  }) : super(key: key);
