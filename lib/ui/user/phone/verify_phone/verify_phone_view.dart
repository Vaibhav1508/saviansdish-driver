...
import 'package:flutterrtdeliveryboyapp/viewobject/holder/phone_login_parameter_holder.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<UserProvider>(
      ...
      create: (BuildContext context) {
        ...
        provider.phoneId = widget.phoneId;
        provider.userName = widget.userName;
        provider.phoneNo = widget.phoneNumber;
...
dynamic gotoProfile(
  ...
  if (await Utils.checkInternetConnectivity()) {
    ...
    if (_apiStatus.data != null) {
      await provider.replaceLoginUserData(
