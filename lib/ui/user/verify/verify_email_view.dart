...
import 'package:flutterrtdeliveryboyapp/viewobject/holder/resend_code_holder.dart';
import 'package:flutterrtdeliveryboyapp/viewobject/holder/user_email_verify_parameter_holder.dart';
...
class VerifyEmailView extends StatefulWidget {
  const VerifyEmailView(
      {Key key, @required this.animationController, this.callback
                ...
                if (codeController.text.isEmpty) {
                  ...
                  if (await Utils.checkInternetConnectivity()) {
                    final EmailVerifyParameterHolder
                      ...
                      // ; (widget.psValueHolder.userIdToVerify == null ||
                    ...
                    if (_apiStatus.data != null) {
                      ...
                      // widget.provider
                      //     .replaceIsDeliveryBoy(_apiStatus.data.userFlag);
                      ...
                      widget.provider.replaceLoginUserData('', '', '', '',
                          _apiStatus.data.userId, _apiStatus.data.userFlag);

                      //   await widget.onProfileSelected(
                      //       _apiStatus.data.userId, _apiStatus.data.userFlag);
                      // } else {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        MaterialButton(
          ...
          highlightColor: PsColors.transparent,
          height: 40,
          child: Text(Utils.getString(context, 'email_verify__login')),
          textColor: PsColors.mainColor,
          onPressed: () {
            // if (widget.onSignInSelected != null) {
            //   widget.onSignInSelected();
